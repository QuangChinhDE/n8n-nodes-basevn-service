		...
		options: [
			{
				...
				type: 'string',
				default: '',
				description: 'New name/title of the ticket',
			},
			{
				displayName: 'Content',
				name: 'content',
				...
				default: '',
				description: 'New description/content of the ticket',
			},
		],
	},
];
...
export async function execute(
	...
	const response = await serviceManagementApiRequest.call(this, 'POST', '/ticket/update', body);
